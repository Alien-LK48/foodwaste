    ...
    <section className="py-12 px-6 bg-gray-50">
      <div className="max-w-5xl mx-auto shadow-2xl p-[20px] rounded-3xl">
        ...
        <p className="mt-6 text-lg text-gray-700 text-justify">
          ...
          decided to take action, and that's how our mission was born—rescue surplus food and get it to those who need it the most.
        </p>
        <p className="mt-4 text-lg text-gray-700 text-justify">
          What started as a small local initiative quickly gained momentum as more people joined our cause, bringing with them 
