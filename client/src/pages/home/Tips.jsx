    ...
    return (
        <>
            <div className="bg-gray-100 py-12">
                <h2 className="text-4xl font-bold text-center mb-8">Food Waste Reduction Tips</h2>
                ...
                <div className="relative overflow-hidden">
                    <div className="flex animate-scroll gap-8 px-6">
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/meal-planning.png" alt="Plan Your Meals" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/food-storage.png" alt="Store Food Properly" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/leftovers.png" alt="Use Leftovers Creatively" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/compost.png" alt="Compost Scraps" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/right-portion.png" alt="Serve Correct Portions" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/expiration-date.png" alt="Understand Expiration Dates" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/bulk-buying.png" alt="Buy in Bulk" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/donate-food.png" alt="Donate Extra Food" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/freeze-food.png" alt="Freeze Food" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/leftover-soups.png" alt="Make Leftover Soups" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/use-stale-bread.png" alt="Use Stale Bread" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/ripen-fruits.png" alt="Ripen Fruits" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/portion-control.png" alt="Portion Control" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/fresh-herbs.png" alt="Grow Fresh Herbs" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/proper-thawing.png" alt="Properly Thaw Food" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/use-peels.png" alt="Use Peels" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/one-pot-meals.png" alt="Cook One-Pot Meals" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/pickling.png" alt="Pickle Excess Vegetables" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/use-bone-broth.png" alt="Make Bone Broth" className="w-16 mx-auto mb-4" />
                        ...
                        <div className="flex-none w-[calc(25%-1rem)] bg-white p-6 rounded-lg shadow-lg text-center">
                            <img src="/refrigerate-leftovers.png" alt="Refrigerate Leftovers Immediately" className="w-16 mx-auto mb-4" />
