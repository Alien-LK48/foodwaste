            ...
            <div className='flex flex-wrap gap-[20px] justify-center items-center align-middle'>
                ...
                <div className="card card-compact bg-base-100 w-96 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        whileInView={{ y: [100, 0], opacity: [0, 1] }}
                        transition={{ delay: 0.25, duration: 1.5 }} 
                        className='text-justify'>Redistribution is about making rescued food available to those who need it the most. Once food is rescued, it is shared with local charities, shelters, and food banks, ensuring that it reaches communities who are struggling with food insecurity. By redistributing surplus food, we not only address hunger but also create a sense of community and support. It's a sustainable way of ensuring that no good food goes to waste when others can benefit from it.</motion.p>
                    </div>
                </div>
                <div className="card card-compact bg-base-100 w-96 shadow-xl">
                    <motion.figure
                    ...
                    <div className="card-body">
                        ...
                        whileInView={{ x: [100, 0], opacity: [0, 1] }}
                        transition={{ delay: 0.25, duration: 1.5 }} 
                        className='text-justify'>Reducing food waste starts with small changes in our daily habits. By learning how to properly store food, plan meals, and use leftovers, we can significantly lower the amount of food that goes uneaten. Encouraging families, businesses, and individuals to adopt these waste-free practices is crucial for creating long-term change. The less food we waste, the less strain we put on our environment and resources, leading to a healthier planet for future generations.</motion.p>
                    </div>
                </div>
